    ...
    */
    ...
    public async Task PostAreShown() {
        ...
        await Expect(Page.Locator("#messagelist")).ToContainTextAsync(
            "Jacqualine Gilcoine Starbuck now is what we hear the worst. — 2023-08-01 13:17:39");
    }
    ...
    public async Task tryXSSAttackOnSendCheep() {
        ...
        await Expect(Page.Locator("#messagelist")).ToContainTextAsync(
            "TestDisplayName Hello, I am feeling good!<script>alert('If you see this in a popup, you are in trouble!');</script>");
    }
    ...
    public async Task SendingCheepOnPublicVsPrivate() {
        ...
        await Page.GetByRole(AriaRole.Button, new() { Name = "Share" }).ClickAsync();
        await Expect(Page.GetByRole(AriaRole.Listitem)
                         .Filter(new() { HasText = "Helge Cheep from public" })).ToBeVisibleAsync();
        ...
        await Page.GetByRole(AriaRole.Button, new() { Name = "Share" }).ClickAsync();
        await Expect(Page.GetByRole(AriaRole.Listitem)
                         .Filter(new() { HasText = "Helge Cheep from private" }))
           .ToBeVisibleAsync();
    ...
    public async Task TooLongMessage() {
        ...
        await Page.GetByRole(AriaRole.Button, new() { Name = "Share" }).ClickAsync();
        await Expect(Page.Locator("#messagelist")).ToContainTextAsync(
            "Helge This Messages Last Carekter should be a A. AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public async Task EmojiTest() {
        ...
        await Expect(Page.Locator("#messagelist"))
           .ToContainTextAsync("Helge Look at this emoji 😁. It's cool");
    }
