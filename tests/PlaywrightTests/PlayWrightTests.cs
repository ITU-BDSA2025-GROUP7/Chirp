...
public class PlayWrightTests : PageTest, IClassFixture<EndToEndWebApplicationFactory>
{
    ...
    public async Task DeleteARegisteredUser()
    {
        ...
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).FillAsync("Test@EmailsYayaya.dk");
    ...
    public async Task ConfirmationPasswordNeedsToMatch()
    {
        ...
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).FillAsync("tester@Testmail.dk");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Username" }).ClickAsync();
        ...
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Password" }).FillAsync("Lillek4t!");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Confirm Password" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Confirm Password" }).FillAsync("lillekat!");
        await Page.GetByRole(AriaRole.Button, new() { Name = "Register" }).ClickAsync();
        await Expect(Page.Locator("#registerForm")).ToContainTextAsync("The password and confirmation password do not match.");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Password" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Password" }).FillAsync("Lillek4t!");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Confirm Password" }).ClickAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Register" }).ClickAsync();
    ...
    public async Task BlankUsernameNotAllowed()
    {
        ...
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).FillAsync("Tester@SuperTester.dk");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "Display Name" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "Display Name" }).FillAsync("TesterDisplayname");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Password" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Password" }).FillAsync("Lillek4t!");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Confirm Password" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Confirm Password" }).FillAsync("Lillek4t!");
    ...
    public async Task UsernameMustBeUnique()
    {
        ...
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).FillAsync("Tester@Email1.dk");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Username" }).ClickAsync();
        ...
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Email" }).FillAsync("Tester@email2.dk");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Username" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Username" }).FillAsync("Username1");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "Display Name" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "Display Name" }).FillAsync("displayname2");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Password" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Password" }).FillAsync("Lillek4t!");
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Confirm Password" }).ClickAsync();
        await Page.GetByRole(AriaRole.Textbox, new() { Name = "*Confirm Password" }).FillAsync("Lillek4t!");
