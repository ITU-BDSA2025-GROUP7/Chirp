...
INSERT INTO message (author_id, text, pub_date)
    ...
    (5, 'Hello, you rascal!', 1756464518),
    (3, 'I can''t believe I am actually cheeping!', 1757066819),
    (3, 'maybe I can believe I am actually cheeping...', 1757067430),
    (4, 'wow, so this is what it feels like to cheep!', 1757242423);